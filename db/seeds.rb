...
ActiveRecord::Base.transaction do
    ...
    def generate_rand_attr

        attributes = Hash.new()
        attributes[:author_id] = rand(0...names.length)
        attributes[:pledge_goal] = rand(1000...1000000)
        attributes[:pledge_amount] = attributes[:pledge_goal]*(rand(0...101)/100)
        day = rand(1...30)
        month = rand(7...13)
        year = ['2019', '2020'].sample
        date_str = day.to_s + "-" + month.to_s + "-" + year
    ...
    project1 = Project.create( generate_rand_attr, 
    ...
    project1.attach(io: file, filename: 'dwelling')

    project2 = Project.create( generate_rand_attr, 
    ...
    project2.attach(io:file2, filename: 'vector')

    project3 = Project.create( generate_rand_attr, 
    ...
    project3.attach(io: file3, filename: 'lumi')
  

    project4 = Project.create( generate_rand_attr, 
    ...
    project4.attach(io: file4, filename: 'lyra')

    project5 = Project.create( generate_rand_attr, 
    ...
    project5.attach(io: file5, filename: 'brothers')

    project6 = Project.create( generate_rand_attr, 
    ...
    project6.attach(io: file6, filename: 'cavity')

    project7 = Project.create( generate_rand_attr, 
    ...
    project7.attach(io: file7, filename: 'knife')

    project8 = Project.create( generate_rand_attr, 
    ...
    file8 = open('')
    project8.attach(io: file8, filename: 'vinyl')

    project9 = Project.create( generate_rand_attr, 
    ...
    project9.attach(io: file9, filename: 'vinyl')

    project10 = Project.create( generate_rand_attr, 
    ...
    project10.attach(io: fil10, filename: 'root')
